...
typedef unsigned int Dimension[2];

class Viewpoint {
      Vector3 eye, dir, updir;
}

class Clonable {
public:
       virtual Clonable clone(void) = 0;
};
...
class RayTracable {
public:
       virtual void Trace(Viewpoint v, Plane imgplane, Dimension imgsize) = 0;
};

class Ellipsoid: public Object, Clonable, RayTracable {
      Vector3 center[3], axes[3];
}
